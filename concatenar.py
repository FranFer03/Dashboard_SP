...
def join_csv(path="CSV/", out_file=None):
    """
...
def main():
    ...
    file = "SP_Database.csv" in os.listdir()
    if file:
        os.remove("SP_Database.csv")
    cvs_directory = os.path.join(current_directory, 'CSV')
    join_csv(path=cvs_directory ,out_file="../SP_Database.csv")
